...
if ( ! function_exists( 'wp_bootstrap_starter_comment' ) ) :
    ...
    function wp_bootstrap_starter_comment( $comment, $args, $depth ) {
        ...
        <?php else : ?>
            <div id="comment-<?php comment_ID(); ?>" <?php comment_class( 'd-flex' ); ?>>
				...
				<div class="flex-grow-1">
					...
					<p class="comment-meta">
						<a href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ); ?>"><time datetime="<?php comment_time( 'c' ); ?>"><?php printf( _x( '%1$s at %2$s', '1: date, 2: time', 'wp-bootstrap-starter' ), get_comment_date(), get_comment_time()); ?></time></a> | 
